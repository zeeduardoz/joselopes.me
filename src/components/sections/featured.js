...
const Featured = () => {
  const data = useStaticQuery(graphql`
    {
      featuredPT: allMarkdownRemark(
        filter: { fileAbsolutePath: { regex: "/pt/featured/" } }
      ...
      featuredEN: allMarkdownRemark(
        filter: { fileAbsolutePath: { regex: "/en/featured/" } }
        sort: { fields: [frontmatter___date], order: ASC }
      ) {
        edges {
          node {
            ...
            return (
              <StyledProject key={i} ref={el => (revealProjects.current[i] = el)}>
                <div className="project-content">
                  <div>
                    <p className="project-overline">{t('Sections.Projects.featured')}</p>
